...
<!-- Mirrored from demo.themefisher.com/vixcon-bootstrap/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 16:44:47 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="content text-center">
                    <h1 class="mb-3 text-white text-capitalize letter-spacing">Login</h1>
                    <div class="divider mx-auto mb-4 bg-white"></div>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a href="index-2.html">Home</a></li>
                        <li class="list-inline-item">/</li>
                        <li class="list-inline-item"><a href="index-2.html">Login</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="section login">
	<div class="container">
		<div class="row no-gutters box-shadow align-items-center">
			<div class="col-lg-6">
				<img src="images/about/login.jpg" alt="" class="img-fluid">
			</div>
			<div class="col-lg-6">
				<div class="login-form  p-5 border-left">
					<h2 class="mb-2">Login</h2>
					<p class="mb-4">Don’t have an account? <a href="signup.html" class="text-color">Create a free account</a></p>
					...
					<form action="#">
						...
						<a href="#" class="btn btn-hero btn-rounded mt-3">Login</a>
					</form>
				</div>
			</div>
		</div>
